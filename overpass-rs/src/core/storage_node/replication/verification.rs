...
use crate::core::types::ovp_ops::{Operation, OperationType};
use crate::core::types::ovp_ops::{OperationType::*};
use crate::core::types::ovp_ops::{Operation::*};
use crate::core::types::ovp_ops::{OpAddPeer, OpRemovePeer};
use crate::core::types::ovp_ops::{OpStoreUpdate, OpRetrieveUpdate};
...
impl ResponseManager {
    pub fn create(node_id: [u8; 32], response_threshold: u64, response_interval: u64)
    ...
    async fn verify_single_response(&self, proof: &[u8; 32]) -> Result<(), SystemError> {
        ...
        let proof = Proof::<ark_bn254::Bn254>::read(&proof_bytes[..]).map_err(|_| SystemError::new(
