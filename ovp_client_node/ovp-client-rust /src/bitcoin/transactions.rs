...
impl TransactionManager {
    ...
    pub fn create_htlc_transaction(
        ...
        contract_address: &Address<NetworkChecked>,
        amount: Amount,
        timelock: u32,
        hash_lock: [u8; 32],
        fee_rate: Amount,
...
mod tests {
    ...
    fn test_htlc_creation() {
        ...
        let sender =
            Address::<NetworkUnchecked>::from_str("bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4")
                .unwrap()
                .require_network(Network::Bitcoin)
                .expect("Invalid network");

        let contract =
            Address::<NetworkUnchecked>::from_str("bc1qw508d6qejxtdg4y5r3zarvaryvg6kdaj")
                .unwrap()
                .require_network(Network::Bitcoin)
                .expect("Invalid network");
